...
# copy to server
pscp -scp -l ${ipinterative_user} -pw ${ipinteractive_ssh_passphrase} -i ..\secrets\ipinteractive.ppk hsm-arduino-backend-webapp\target\hsm-arduino-backend-webapp.jar ${ipinterative_ip}:~${ipinterative_user}/build_temp/maven/
